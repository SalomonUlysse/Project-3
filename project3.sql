...
--
-- Table structure for table `hasteam`
--

CREATE TABLE `hasteam` (
  `ID` int(11) NOT NULL,
  `TrainerNo` int(11) NOT NULL,
  `DexNum` int(11) NOT NULL,
  `Level` int(11) NOT NULL,
  `CurHP` int(11) NOT NULL,
  `CurAtk` int(11) NOT NULL,
  `CurDef` int(11) NOT NULL,
  `CurSpAtk` int(11) NOT NULL,
  `CurSpDef` int(11) NOT NULL,
  `CurSpeed` int(11) NOT NULL,
  `EXP` int(11) NOT NULL
...
INSERT INTO `pokemon` (`DexNum`, `Name`, `Type1`, `Type2`, `Total_Stats`, `HP`, `Attack`, `Defense`, `Sp_Attack`, `Sp_Defense`, `Speed`, `Generation`, `Legendary`) VALUES
...
--
-- Indexes for table `hasteam`
--
ALTER TABLE `hasteam`
  ADD PRIMARY KEY (`TrainerNo`,`DexNum`,`ID`) USING BTREE,
...
--
ALTER TABLE `pokemon`
  ADD PRIMARY KEY (`DexNum`);

--
-- Indexes for table `trainer`
--
ALTER TABLE `trainer`
  ADD PRIMARY KEY (`TrainerNo`);
...
--
-- AUTO_INCREMENT for table `hasteam`
--
ALTER TABLE `hasteam`
...
--
ALTER TABLE `trainer`
  MODIFY `TrainerNo` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
